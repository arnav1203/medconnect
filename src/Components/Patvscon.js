            ...
            <div className='md:flex md:justify-around'>
                <div className='w-2/5'>
                    ...
                    <div className='pt-10'>
                        ...
                        <div className='w-full p-10'>
                            <a href="#_" class="relative inline-flex border border-orange-500 items-center justify-start px-6 py-3 overflow-hidden font-medium transition-all bg-white rounded hover:bg-white group">
                                <span class="w-60 h-52 rounded rotate-[-40deg] bg-orange-600 absolute bottom-0 left-0 -translate-x-full ease-out duration-500 transition-all translate-y-full mb-9 ml-9 group-hover:ml-0 group-hover:mb-32 group-hover:translate-x-0"></span>
                ...
                <div className='w-2/5'>
                    ...
                    <div className='pt-10'>
                        ...
                        <div className='w-full p-10'>
                            <a href="#_" class="relative inline-flex items-center border border-orange-500 justify-start px-6 py-3 overflow-hidden font-medium transition-all bg-white rounded hover:bg-white group">
                                <span class="w-60 h-64 rounded rotate-[-40deg] bg-orange-600 absolute bottom-0 left-0 -translate-x-full ease-out duration-500 transition-all translate-y-full mb-9 ml-16 group-hover:ml-8 group-hover:mb-32 group-hover:translate-x-0"></span>
